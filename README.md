...
[![Build Status](https://travis-ci.org/atyc/openstreetmap-tile-server.svg?branch=master)](https://travis-ci.org/atyc/openstreetmap-tile-server) [![](https://images.microbadger.com/badges/image/atyc/openstreetmap-tile-server.svg)](https://microbadger.com/images/atyc/openstreetmap-tile-server "openstreetmap-tile-server")
...
docker run \
    ...
    atyc/openstreetmap-tile-server \
    import
```
...
docker run \
    -p 8080:80 \
    -v openstreetmap-data:/var/lib/postgresql/12/main \
    -d atyc/openstreetmap-tile-server \
    run
```
